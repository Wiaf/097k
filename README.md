========================================================================
    KONSOLENANWENDUNG: Team-Builder0.4-Projektübersicht
========================================================================

Diese Team-Builder0.4-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die Team-Builder0.4-Anwendung besteht.


Team-Builder0.4.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen Team-Builder0.4.pch sowie eine vorkompilierte 
